...
class Agent(BaseAgent):
    ...
    def next_move(self, state):
        ...
        if self.defect_streak >= 5 and opponent_last_move == 1 and self.cooperate_streak < 2:
            return 1
        ...
        if opponent_last_move == -1 and own_last_move == 1 and self.defect_streak==1:
            return 1
        
        if opponent_last_move == -1 and own_last_move == 1 and self.defect_streak==2:
            return -1
        ...
        # Cooperate if opponent cooperated last round or if we defected
        return 1